...
def create_app(test_config=None):
    ...
    # including pagination (every 10 questions). This endpoint
    # should return a list of questions, number of total
    # questions, current category, categories.
    # TEST: At this point, when you start the application
    # you should see questions and categories generated,
    # ten questions per page and pagination at the bottom
    # of the screen for three pages. Clicking on the page
    ...
    # which will require the question and answer
    ...
    def category_list(cat_id):
        try:
            cat_select = Category.query.filter(
